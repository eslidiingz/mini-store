...
import { iSaleProduct } from '@/models/sale_product'

type ReportTableProps = {
    sale_products: {
        results: iSaleProduct[]
    }
}
const ReportTable = ({ sale_products }: ReportTableProps) => {
    console.log("%c%s", "background: #04b8f4; color: #000000", "🚀 ~ file: ReportTable.tsx:9 ~ ReportTable ~ sale_products:", sale_products)
    return (
        <section>
